...
if not exist "DeadToMe.mp3" if "%input%"=="4" wget https://github.com/ZorritoYT/SongsTMP/raw/main/DeadToMe.mp3 & del /q .wget-hsts & start dlc -w -p "DeadToMe.mp3" & start /b cmdbkg "%locate%\Files\Sounds\DeadToMe.bmp" 65 incluideborders
goto loop
